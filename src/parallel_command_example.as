...
package
{
	 ...
	 *
	 */
	public class parallel_command_example extends Sprite
	{
		///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public function parallel_command_example()
		{
			super();
			context=new Context();
			...
			executor.executeCommand(MyParallelCommand, responseEvent, executorResponder);
		}
...
class MyParallelCommand extends ParallelCommand
{    
